    ...
    <section role="navigation" class="navbar custom-navbar navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- lOGO TEXT HERE -->
                <a href="index.jsp" class="navbar-brand">学社</a>
            </div>
            <!-- MENU LINKS -->
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-nav-first">
                    ...
                    <li>
                        <a href="clubs.jsp" class="smoothScroll">百团大展</a>
                    </li>
                    <li>
                        <a href="clubManagement.jsp" class="smoothScroll">社团管理</a>
                    </li>
                    <li>
                        <a href="userCenter.jsp" class="smoothScroll">个人中心</a>
                    </li>
                    <li>
...
<%--                    <!-- BLOG THUMB -->    239*359 px--%>
                    <div class="media blog-thumb">
                        <div class="media-object media-left">
                            <a href="clubDetails.jsp?club_id=3"><img src="img/img01.png" alt="" class="img-responsive"/></a>
                        </div>
                        <div class="media-body blog-info">
                            ...
                            <a href="clubDetails.jsp?club_id=3" class="btn section-btn">了解更多</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            ...
                            <a href="clubDetails.jsp?club_id=1" class="btn section-btn">了解更多</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            ...
                            <a href="clubDetails.jsp?club_id=4" class="btn section-btn">了解更多</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            ...
                            <a href="clubDetails.jsp?club_id=2" class="btn section-btn">了解更多</a>
                        </div>
                    </div>
                </div>
            </div>
